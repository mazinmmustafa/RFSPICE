...
hold off
axis equal
axis([Data_min Data_max Data_min Data_max ])
title('$20\log_{10}|E_{\theta}|$ vs $\theta$','Interpret','Latex')
legend('Exact','Far Field','Interpreter','Latex','Location','NorthEast')
xlabel('dB','Interpret','Latex')
ylabel('dB','Interpret','Latex')
%% Export to pdf
% export_fig 'C:\Users\Mazin\Desktop\UpperQuarter' -pdf -transparent
%% Plot Lower Quarter
figure()
Data_min    =   250;
Data_max    =   280;
...
axis([Data_min Data_max Data_min Data_max ])
title('$20\log_{10}|E_{\theta}|$ vs $\theta$','Interpret','Latex')
legend('Exact','Far Field','Interpreter','Latex','Location','SouthEast')
xlabel('dB','Interpret','Latex')
ylabel('dB','Interpret','Latex')
%% Export to pdf
% export_fig 'C:\Users\Mazin\Desktop\LowerQuarter' -pdf -transparent
%% Plot E_theta
figure()
Data_min    =   0;
Data_max    =   18;
...
Data        =   20*log10(Data);
Data(Data<Data_min)=Data_min;
PolardB(theta,Data,[Data_min Data_max],4,'k',1)
hold on
...
Data        =   20*log10(Data);
Data(Data<Data_min)=Data_min;
PolardB(theta,Data,[Data_min Data_max],6,'k',1)
hold on
